...
// CHECK:           %[[TILE_SLICE_INDEX_I64:.*]] = builtin.unrealized_conversion_cast %[[TILE_SLICE_INDEX]] : index to i64
...
// CHECK:           %[[TILE_SLICE_INDEX_I32:.*]] = llvm.trunc %[[TILE_SLICE_INDEX_I64]] : i64 to i32
// CHECK:           "arm_sme.intr.x.ld1b.horiz"(%[[MASK]], %[[GEP]], %[[TILE_SLICE_INDEX_I32]]) : (vector<[16]xi1>, !llvm.ptr, i32) -> !llvm.target<"aarch64.za.b">
// CHECK:           return
// CHECK:         }
...
// CHECK: "arm_sme.intr.x.ld1h.horiz"({{.*}}) : (vector<[8]xi1>, !llvm.ptr, i32) -> !llvm.target<"aarch64.za.h">
...
// CHECK: "arm_sme.intr.x.ld1w.horiz"({{.*}}) : (vector<[4]xi1>, !llvm.ptr, i32) -> !llvm.target<"aarch64.za.s">
...
// CHECK: "arm_sme.intr.x.ld1d.horiz"({{.*}}) : (vector<[2]xi1>, !llvm.ptr, i32) -> !llvm.target<"aarch64.za.d">
...
// CHECK: "arm_sme.intr.x.ld1q.horiz"({{.*}}) : (vector<[1]xi1>, !llvm.ptr, i32) -> !llvm.target<"aarch64.za.q">
...
// CHECK: "arm_sme.intr.x.ld1b.vert"({{.*}}) : (vector<[16]xi1>, !llvm.ptr, i32) -> !llvm.target<"aarch64.za.b">
...
// CHECK: "arm_sme.intr.x.ld1h.vert"({{.*}}) : (vector<[8]xi1>, !llvm.ptr, i32) -> !llvm.target<"aarch64.za.h">
...
// CHECK: "arm_sme.intr.x.ld1w.vert"({{.*}}) : (vector<[4]xi1>, !llvm.ptr, i32) -> !llvm.target<"aarch64.za.s">
...
// CHECK: "arm_sme.intr.x.ld1d.vert"({{.*}}) : (vector<[2]xi1>, !llvm.ptr, i32) -> !llvm.target<"aarch64.za.d">
...
// CHECK: "arm_sme.intr.x.ld1q.vert"({{.*}}) : (vector<[1]xi1>, !llvm.ptr, i32) -> !llvm.target<"aarch64.za.q">
...
// CHECK-DAG:       %[[LLVM_TILE:.*]] = builtin.unrealized_conversion_cast %[[TILE]] : vector<[16]x[16]xi8> to !llvm.target<"aarch64.za.b">
// CHECK-DAG:       %[[MEM_DESC:.*]] = builtin.unrealized_conversion_cast %[[DEST]] : memref<?x?xi8> to !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>
// CHECK-DAG:       %[[TILE_SLICE_INDEX_I64:.*]] = builtin.unrealized_conversion_cast %[[TILE_SLICE_INDEX]] : index to i64
...
// CHECK:           %[[GEP:.*]] = llvm.getelementptr %[[ALIGNED_BASE]]{{\[}}%[[OFFSET]]] : (!llvm.ptr, i64) -> !llvm.ptr, i8
// CHECK:           %[[TILE_SLICE_INDEX_I32:.*]] = llvm.trunc %[[TILE_SLICE_INDEX_I64]] : i64 to i32
// CHECK:           "arm_sme.intr.x.st1b.horiz"(%[[MASK]], %[[GEP]], %[[LLVM_TILE]], %[[TILE_SLICE_INDEX_I32]]) : (vector<[16]xi1>, !llvm.ptr, !llvm.target<"aarch64.za.b">, i32) -> ()
// CHECK:           return
// CHECK:         }
...
// CHECK: "arm_sme.intr.x.st1h.horiz"({{.*}}) : (vector<[8]xi1>, !llvm.ptr, !llvm.target<"aarch64.za.h">, i32) -> ()
...
// CHECK: "arm_sme.intr.x.st1w.horiz"({{.*}}) : (vector<[4]xi1>, !llvm.ptr, !llvm.target<"aarch64.za.s">, i32) -> ()
...
// CHECK: "arm_sme.intr.x.st1d.horiz"({{.*}}) : (vector<[2]xi1>, !llvm.ptr, !llvm.target<"aarch64.za.d">, i32) -> ()
...
// CHECK: "arm_sme.intr.x.st1q.horiz"({{.*}}) : (vector<[1]xi1>, !llvm.ptr, !llvm.target<"aarch64.za.q">, i32) -> ()
...
// CHECK: "arm_sme.intr.x.st1b.vert"({{.*}}) : (vector<[16]xi1>, !llvm.ptr, !llvm.target<"aarch64.za.b">, i32) -> ()
...
// CHECK: "arm_sme.intr.x.st1h.vert"({{.*}}) : (vector<[8]xi1>, !llvm.ptr, !llvm.target<"aarch64.za.h">, i32) -> ()
...
// CHECK: "arm_sme.intr.x.st1w.vert"({{.*}}) : (vector<[4]xi1>, !llvm.ptr, !llvm.target<"aarch64.za.s">, i32) -> ()
...
// CHECK: "arm_sme.intr.x.st1d.vert"({{.*}}) : (vector<[2]xi1>, !llvm.ptr, !llvm.target<"aarch64.za.d">, i32) -> ()
...
// CHECK: "arm_sme.intr.x.st1q.vert"({{.*}}) : (vector<[1]xi1>, !llvm.ptr, !llvm.target<"aarch64.za.q">, i32) -> ()
