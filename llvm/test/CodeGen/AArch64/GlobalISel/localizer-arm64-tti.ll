...
define i32 @foo() {
  ...
  ; CHECK-NEXT:   STRWui renamable $w10, renamable $x12, 0 :: (store (i32) into @var2)
  ; CHECK-NEXT:   STRWui renamable $w8, renamable $x9, 0 :: (store (i32) into @var1)
  ; CHECK-NEXT:   STRWui renamable $w10, renamable $x11, 0 :: (store (i32) into @var3)
  ; CHECK-NEXT:   STRWui renamable $w8, renamable $x9, 0 :: (store (i32) into @var1)
  ; CHECK-NEXT:   B %bb.2
  ; CHECK-NEXT: {{  $}}
...
define i32 @darwin_tls() {
  ...
  ; CHECK-NEXT:   renamable $w8 = LDRWui renamable $x8, 0 :: (dereferenceable load (i32) from @tls_gv)
  ; CHECK-NEXT:   STRWui killed renamable $w8, renamable $x9, 0 :: (store (i32) into @var2)
  ; CHECK-NEXT:   B %bb.2
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.2.if.end:
...
define i32 @imm_cost_too_large_cost_of_2() {
  ...
  ; CHECK-NEXT:   STRWui renamable $w8, renamable $x9, 0 :: (store (i32) into @var2)
  ; CHECK-NEXT:   B %bb.2
  ; CHECK-NEXT: {{  $}}
  ...
  ; CHECK-NEXT:   STRWui killed renamable $w8, killed renamable $x9, 0 :: (store (i32) into @var3)
  ; CHECK-NEXT:   $sp = frame-destroy ADDXri $sp, 48, 0
  ; CHECK-NEXT:   RET undef $lr, implicit killed $w0
entry:
  %0 = load i32, ptr @var1, align 4
...
define i64 @imm_cost_too_large_cost_of_4() {
  ...
  ; CHECK-NEXT:   $x9 = LDRXui $sp, 3 :: (load (s64) from %stack.2)
  ; CHECK-NEXT:   STRXui renamable $x8, renamable $x9, 0 :: (store (i64) into @var2_64)
  ; CHECK-NEXT:   B %bb.2
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.2.if.then2:
  ; CHECK-NEXT:   successors: %bb.3(0x80000000)
  ...
  ; CHECK-NEXT:   $x8 = LDRXui $sp, 2 :: (load (s64) from %stack.3)
  ; CHECK-NEXT:   $x9 = LDRXui $sp, 1 :: (load (s64) from %stack.4)
  ; CHECK-NEXT:   STRXui renamable $x8, renamable $x9, 0 :: (store (i64) into @var1_64)
  ; CHECK-NEXT:   B %bb.3
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.3.if.end:
  ...
  ; CHECK-NEXT:   $x8 = LDRXui $sp, 2 :: (load (s64) from %stack.3)
  ; CHECK-NEXT:   $x9 = LDRXui $sp, 4 :: (load (s64) from %stack.1)
  ; CHECK-NEXT:   STRXui killed renamable $x8, killed renamable $x9, 0 :: (store (i64) into @var3_64)
  ; CHECK-NEXT:   $sp = frame-destroy ADDXri $sp, 48, 0
...
define i64 @f64_imm_cost_too_high(double %a) {
  ...
  ; CHECK-NEXT:   $x8 = LDRXui $sp, 2 :: (load (s64) from %stack.3)
  ; CHECK-NEXT:   $x9 = LDRXui $sp, 3 :: (load (s64) from %stack.2)
  ; CHECK-NEXT:   STRXui renamable $x8, renamable $x9, 0 :: (store (f64) into @var2_64)
  ; CHECK-NEXT:   B %bb.2
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.2.if.then2:
  ; CHECK-NEXT:   successors: %bb.3(0x80000000)
  ...
  ; CHECK-NEXT:   $x8 = LDRXui $sp, 2 :: (load (s64) from %stack.3)
  ; CHECK-NEXT:   $x9 = LDRXui $sp, 1 :: (load (s64) from %stack.4)
  ; CHECK-NEXT:   STRXui renamable $x8, renamable $x9, 0 :: (store (f64) into @var1_64)
  ; CHECK-NEXT:   B %bb.3
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.3.if.end:
  ; CHECK-NEXT:   $x0 = LDRXui $sp, 5 :: (load (s64) from %stack.0)
  ; CHECK-NEXT:   $x8 = LDRXui $sp, 2 :: (load (s64) from %stack.3)
  ; CHECK-NEXT:   $x9 = LDRXui $sp, 4 :: (load (s64) from %stack.1)
  ; CHECK-NEXT:   STRXui killed renamable $x8, killed renamable $x9, 0 :: (store (f64) into @var3_64)
  ; CHECK-NEXT:   $sp = frame-destroy ADDXri $sp, 48, 0
  ; CHECK-NEXT:   RET undef $lr, implicit killed $x0
entry:
  %0 = load i64, ptr @var1_64, align 4
...
define i64 @f64_imm_cheap(double %a) {
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   $x8 = LDRXui $sp, 1 :: (load (s64) from %stack.2)
  ; CHECK-NEXT:   STRXui $xzr, renamable $x8, 0 :: (store (f64) into @var2_64)
  ; CHECK-NEXT:   B %bb.2
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.2.if.then2:
  ; CHECK-NEXT:   successors: %bb.3(0x80000000)
  ...
  ; CHECK-NEXT:   STRXui $xzr, renamable $x8, 0 :: (store (f64) into @var1_64)
  ; CHECK-NEXT:   B %bb.3
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.3.if.end:
  ; CHECK-NEXT:   $x0 = LDRXui $sp, 3 :: (load (s64) from %stack.0)
  ; CHECK-NEXT:   $x8 = LDRXui $sp, 2 :: (load (s64) from %stack.1)
  ; CHECK-NEXT:   STRXui $xzr, killed renamable $x8, 0 :: (store (f64) into @var3_64)
